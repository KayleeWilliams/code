// This file mostly exists because we want dev mode to say "Inth Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Inth Code (Dev)" : "Inth Code (Alpha)";
...
const developmentMacIconPngPath = join(repoRoot, "assets", "inth", "inth-macos-1024.png");
